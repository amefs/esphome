#include "epaper_waveshare_3p97_bwyr.h"
...
static constexpr const char *const TAG = "epaper_spi.waveshare_3p97_bwyr";

enum class Waveshare3P97Color : uint8_t {
  BLACK = 0b00,
  WHITE = 0b01,
  YELLOW = 0b10,
  RED = 0b11,
...
static Waveshare3P97Color HOT color_to_native(Color color) {
  return color_to_bwyr(color, Waveshare3P97Color::BLACK, Waveshare3P97Color::WHITE,
                       Waveshare3P97Color::YELLOW, Waveshare3P97Color::RED);
}

void EPaperWaveshare3P97InBWYR::fill(Color color) {
...
void HOT EPaperWaveshare3P97InBWYR::draw_pixel_at(int x, int y, Color color) {
...
bool EPaperWaveshare3P97InBWYR::reset() {
...
bool EPaperWaveshare3P97InBWYR::initialise([[maybe_unused]] bool partial) {
  switch (this->step_) {
...
bool HOT EPaperWaveshare3P97InBWYR::transfer_data() {
